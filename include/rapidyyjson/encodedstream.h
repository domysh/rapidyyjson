 ...
 *
 * Mirrors `rapidjson/encodedstream.h`.
 */

#ifndef RAPIDYYJSON_ENCODEDSTREAM_H_
#define RAPIDYYJSON_ENCODEDSTREAM_H_
...
#define RAPIDYYJSON_ENCODINGS_FUNC(x) UTF8<Ch>::x, UTF16LE<Ch>::x, UTF16BE<Ch>::x, UTF32LE<Ch>::x, UTF32BE<Ch>::x
    ...
    */
    AutoUTFInputStream(InputByteStream& is, UTFType type = kUTF8)
        : is_(&is),
          ...
          hasBOM_(false)
    {
        RAPIDYYJSON_ASSERT(type >= kUTF8 && type <= kUTF32BE);
        DetectType();
        static const TakeFunc f[] = {RAPIDYYJSON_ENCODINGS_FUNC(Take)};
        takeFunc_ = f[type_];
  ...
  private:
    ...
    void DetectType()
    {
        ...
        if (type_ == kUTF16LE || type_ == kUTF16BE)
            RAPIDYYJSON_ASSERT(sizeof(Ch) >= 2);
        if (type_ == kUTF32LE || type_ == kUTF32BE)
            RAPIDYYJSON_ASSERT(sizeof(Ch) >= 4);
    }
...
class AutoUTFOutputStream
{
  ...
  public:
    ...
    */
          ...
          type_(type)
    {
        ...
        static const PutFunc f[] = {RAPIDYYJSON_ENCODINGS_FUNC(Put)};
        putFunc_ = f[type_];
  ...
  private:
    ...
    void PutBOM()
    {
        ...
        static const PutBOMFunc f[] = {RAPIDYYJSON_ENCODINGS_FUNC(PutBOM)};
        f[type_](*os_);
    }
...
#endif // RAPIDYYJSON_ENCODEDSTREAM_H_
